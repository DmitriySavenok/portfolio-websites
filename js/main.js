...
/***/ "./src/js/components/portfolioSlider.js":
/*!**********************************************!*\
  !*** ./src/js/components/portfolioSlider.js ***!
  \**********************************************/
/*! exports provided: default */
...
function portfolioSlider() {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    if (width > 768) {
      ...
      swiper.on('slideChange', function () {
        console.log('Слайды меняются');
        swiper.activeIndex > 0 ? info.classList.add('hide') : info.classList.remove('hide');
        // swiper.isEnd == true ? links.classList.remove('hide') : links.classList.add('hide')
        swiper.activeIndex >= 5 ? about.classList.remove('hide') : about.classList.add('hide');
  ...
  // 	console.log('Слайды закончались');
  // 	links.classList.toggle('hide')
  // });
}

// function openedSlide() {
// 	document.querySelectorAll('.portfolio__case').forEach(item => {
...
/* harmony import */ var _components_portfolioSlider__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/portfolioSlider */ "./src/js/components/portfolioSlider.js");
...
/* harmony import */ var _modules_themeMode__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/themeMode */ "./src/js/modules/themeMode.js");
...
_components_portfolioSlider__WEBPACK_IMPORTED_MODULE_7__["default"].portfolioSlider();
_modules_themeMode__WEBPACK_IMPORTED_MODULE_10__["default"].themeModeSwitch();
_modules_preloader__WEBPACK_IMPORTED_MODULE_11__["default"].preloader();
